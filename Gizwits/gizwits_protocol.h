...
* @{
*/
#define PRODUCT_KEY "c6e34e1bfaa849e58d46223fd3394e0a"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "511f4b32e04549a58e8040ad61b64fd1"
...
* @{
*/
#define GIVE_TISSUE_BYTEOFFSET                    0
#define GIVE_TISSUE_BITOFFSET                     0
#define GIVE_TISSUE_LEN                           1
#define CURRENT_LENGTH_BYTEOFFSET                    0
#define CURRENT_LENGTH_BITOFFSET                     1
#define CURRENT_LENGTH_LEN                           2
#define FULL_TISSUE_BYTEOFFSET                    1
#define FULL_TISSUE_BITOFFSET                     0
#define FULL_TISSUE_LEN                           1
#define NO_TISSUE_BYTEOFFSET                    2
#define NO_TISSUE_BITOFFSET                     0
#define NO_TISSUE_LEN                           1
#define ERR_JAM_BYTEOFFSET                    3
#define ERR_JAM_BITOFFSET                     0
#define ERR_JAM_LEN                           1
...
typedef enum
{
    CURRENT_LENGTH_VALUE0 = 0,//L15
    CURRENT_LENGTH_VALUE1 = 1,// L60
    CURRENT_LENGTH_VALUE2 = 2,//L80
    CURRENT_LENGTH_VALUE3 = 3,//L100
    CURRENT_LENGTH_VALUE_MAX,
} CURRENT_LENGTH_ENUM_T;
...
typedef struct {
  bool valueGIVE_TISSUE;
  uint32_t valueCURRENT_LENGTH;
  bool valueFULL_TISSUE;
  bool valueNO_TISSUE;
  bool valueERR_JAM;
} dataPoint_t;
...
typedef struct {
  uint8_t flagGIVE_TISSUE:1;
  uint8_t flagCURRENT_LENGTH:1;
} attrFlags_t;
